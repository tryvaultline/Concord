...
Write-Host "[SERVICE] Starting Concord Auth & Encryption Server..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "[HEALTH] Status: $($health.status) | Mode: $($health.mode)" -ForegroundColor Green
} catch {
